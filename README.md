# Netology's homework storage
## Simple python
#### Introducing in python
1. [Домашка про классы (2.2)](https://github.com/guillotine666/netology_homeworks/tree/master/simple/2_2_classes)
1. [Домашка про исключения (2.3)](https://github.com/guillotine666/netology_homeworks/tree/master/simple/2_3_exceptions)
#### Work with file
1. [Домашка про открытие и чтение файла, запись в файл (2.4)](https://github.com/guillotine666/netology_homeworks/tree/master/simple/2_4_files)
...
1. [Домашка про RegEx (2.3)](https://github.com/guillotine666/netology_homeworks/tree/master/advanced/DB_postgresql)